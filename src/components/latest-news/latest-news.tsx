				...
				<div className="w-full max-w-[1400px] h-fit mx-auto">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full">
							...
							<InfoCard
								...
								imgDescription="Bayern x Real Madrid preview"
							>
								<p className="text-xl font-medium">Champions League fixtures</p>
							</InfoCard>
						</div>
					</div>
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8">
						...
						<Link
							...
							className="flex items-center justify-center rounded-md w-[92%] sm:w-[calc(50%-16px)] h-12 mx-auto sm:mx-0 mb-8 text-sm sm:text-base bg-transparent text-uefa-blue hover:text-white hover:bg-uefa-blue hover:transition-colors hover:duration-200 border-[1.5px] border-uefa-blue font-medium"
						>
							View all news
						</Link>
					</div>
