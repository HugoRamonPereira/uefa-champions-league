...
export default function Sponsors() {
  return (
    <section className="bg-[url('/assets/images/ucl-global-sponsors.jpg')] bg-cover bg-center h-40 w-full">
      <div className="w-full max-w-[700px] flex flex-col items-center h-full justify-center gap-4 mx-auto text-sm antialiased font-light tracking-wide pt-10">
